 ...
 ***********************************************************/
 ...
 #define BOARD_BUTTON_PIN_2       TUYA_GPIO_NUM_12
...
#define BOARD_LCD_SPI_CLK            48000000
#define BOARD_LCD_SPI_CS_PIN         TUYA_GPIO_NUM_15
#define BOARD_LCD_SPI_DC_PIN         TUYA_GPIO_NUM_18
 ...
 ***********************************************************/
 ...
 static OPERATE_RET __board_register_button(void)
 {
    ...
    BUTTON_GPIO_CFG_T button2_hw_cfg = {
        .pin = BOARD_BUTTON_PIN_2,
        .level = BOARD_BUTTON_ACTIVE_LV,
        .mode = BUTTON_TIMER_SCAN_MODE,
        .pin_type.gpio_pull = TUYA_GPIO_PULLUP,
    };

    TUYA_CALL_ERR_RETURN(tdd_gpio_button_register(BUTTON_NAME_2, &button2_hw_cfg));
 #endif
     return rt;
 }
...
//      TUYA_CALL_ERR_RETURN(tdd_disp_spi_epd7in5_register(DISPLAY_NAME, &display_cfg));
//  #endif
