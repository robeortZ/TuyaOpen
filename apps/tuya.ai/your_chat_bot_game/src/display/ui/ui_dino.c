...
static lv_disp_t *g_original_disp = NULL;
static lv_display_rotation_t g_original_rotation = LV_DISPLAY_ROTATION_0;
...
static void on_back_to_chat(lv_event_t *e)
{
    ...
    // 恢复原始屏幕旋转
    if (g_original_disp) {
        lv_display_set_rotation(g_original_disp, g_original_rotation);
        g_original_disp = NULL;
    }
