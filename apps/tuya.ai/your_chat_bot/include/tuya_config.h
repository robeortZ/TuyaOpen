...
#define TUYA_OPENSDK_UUID    "uuid8bf9facd875cbfb5"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "TPZVyc9YGc6kHeGpEG6oq8AJVAkQq8VH" // Please change the correct authkey
