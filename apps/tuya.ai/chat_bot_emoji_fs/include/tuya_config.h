...
#define TUYA_OPENSDK_UUID    "uuid498da20a4fa6cc7f"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "OJLhdHpm7mnTi7sXi2jAvpkXY7zgk1Hb" // Please change the correct authkey
